...
public class Elements {
    ...
    double atomic_weight;
        ...
        Elements(int AN,String name,String sym,String clas,double AW)//constrctor 
        {
                atomic_number=AN;
                name_element=name;
                Symbol_element=sym;
...
public void AW_above15()
{
        ...
        public static void main(String args[]){
            ...
            for(int i=0;i<num;i++)
            {
                    ...
                    System.out.println("Enter the chemical symbol of the element: ");
                    String sym = sc.nextLine();
                    System.out.println("Enter the class of the element: ");
                    String clas = sc.nextLine();
                    System.out.println("Enter the atomic weight of the element: ");
